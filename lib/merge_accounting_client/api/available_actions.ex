...
defmodule MergeAccountingClient.Api.AvailableActions do
  @moduledoc """
  ...
  {:ok, MergeAccountingClient.Model.AvailableActions.t} on success
  {:error, Tesla.Env.t} on failure
  """
  @spec available_actions_retrieve(Tesla.Env.client(), String.t(), String.t(), keyword()) ::
          {:ok, MergeAccountingClient.Model.AvailableActions.t()} | {:error, Tesla.Env.t()}
  def available_actions_retrieve(connection, authorization, x_account_token, _opts \\ []) do
    ...
    |> evaluate_response([
      {200, %MergeAccountingClient.Model.AvailableActions{}}
    ])
  end
end
